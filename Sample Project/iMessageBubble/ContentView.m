...
{
    [self textViewDidChange:textView heightOfMessage:0.0f bubbleEffect:nil];
}
- (void)textViewDidChange:(UITextView *)textView heightOfMessage:(CGFloat)height  bubbleEffect:(void (^)(void))completeHandler
{
    if (completeHandler) {
        UIColor *aniBackgroundColor = [[ChatCellSettings getInstance] getSenderBubbleColor];
        CGFloat aniCornerRadius = 16.0f;
        UIColor *aniTextColor = [[ChatCellSettings getInstance] getSenderBubbleTextColor][1];
        CGFloat aniWidth = [[ChatCellSettings getInstance] getSenderChatMessageLabelWidth] + (16.0f * 2);
        
        NSDictionary *originalTextViewAttributes = @{
                                                     @"kBackgroundColor": textView.backgroundColor,
                                                     @"kLayerCornerRadius": @(textView.layer.cornerRadius),
                                                     @"kTextColor": textView.textColor ? textView.textColor : [UIColor blackColor],
                                                     @"kLayerFrame": NSStringFromCGRect(textView.layer.frame)
                                                     };
             ...
             usingSpringWithDamping:0.4f
              initialSpringVelocity:0.2f
                         ...
                         animations:^{
                             ...
                             textView.backgroundColor = aniBackgroundColor;
                             textView.layer.cornerRadius = aniCornerRadius;
                             textView.textColor = aniTextColor;
                                  ...
                                  usingSpringWithDamping:0.15f
                                   initialSpringVelocity:0.4f
                                              ...
                                              animations:^{
                                                  ...
                                                  CGFloat xDist = [UIScreen mainScreen].bounds.size.width - (textView.frame.size.width + textView.frame.origin.x);
                                                  textView.layer.transform = CATransform3DMakeTranslation(xDist, 0.0f, 0.0f);
                                                  textView.layer.frame = CGRectMake(textView.layer.frame.origin.x, textView.layer.frame.origin.y, aniWidth, height > 0.0f ? height : textView.frame.size.height);
                             ...
                             [UIView animateWithDuration:0.25f
                                              ...
                                              animations:^{
                                                  ...
                                                  textView.layer.transform = CATransform3DTranslate(textView.layer.transform, 0.0f, -textView.frame.size.height*1.1, 0.0f);
                                                  textView.alpha = 1.0f;
                                                  
                                              } completion:^(BOOL finished) {
                                                  
                                                  textView.text = @"";
                                                  [self resizeTextViewWithAnimation:YES];
                                                  ...
                                                  [UIView animateWithDuration:0.2f animations:^{
                                                      ...
                                                      if (finished) {
                                                          ...
                                                          textView.backgroundColor = originalTextViewAttributes[@"kBackgroundColor"];
                                                          textView.layer.cornerRadius = [originalTextViewAttributes[@"kLayerCornerRadius"] floatValue];
                                                          textView.layer.frame = CGRectFromString(originalTextViewAttributes[@"kLayerFrame"]);
                                                          textView.textColor = originalTextViewAttributes[@"kTextColor"];
                                                          textView.alpha = 1.0f;
                                                      }
